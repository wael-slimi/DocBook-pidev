...
class DossierMedicalController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $items = $this->repository->searchAndFilter($search, $tri, $ordre, $dateDebut, $dateFin, $genre, null, 0, $user);
        $total = $this->repository->countSearchAndFilter($search, $dateDebut, $dateFin, $genre, $user);
    ...
    public function new(Request $request): Response
    {
        ...
        $dossier->setPatient($this->getUser());
