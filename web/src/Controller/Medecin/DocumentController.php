...
#[Route('/medecin/dossiers/{dossierId}/documents', requirements: ['dossierId' => '\d+'])]
class DocumentController extends AbstractController
{
    ...
    #[Route('', name: 'app_medecin_document_index', methods: ['GET'])]
    public function index(Request $request, int $dossierId): Response
    {
        ...
        if ($request->isXmlHttpRequest() || $request->query->get('ajax')) {
            $response = $this->render('medecin/document/_list_rows.html.twig', [
                'documents' => $items,
                'dossier' => $dossier,
                'prefix' => '/medecin',
            ]);
        ...
        return $this->render('medecin/document/index.html.twig', [
            'documents' => $items,
            'dossier' => $dossier,
            'total' => $total,
            'q' => $search,
    ...
    #[Route('/nouveau', name: 'app_medecin_document_new', methods: ['GET', 'POST'])]
    public function new(Request $request, int $dossierId): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_medecin_document_index', ['dossierId' => $dossierId]);
        }
        return $this->render('medecin/document/form.html.twig', [
            'document' => $document,
            'dossier' => $dossier,
            'form' => $form,
            'prefix' => '/medecin',
    ...
    #[Route('/{id}', name: 'app_medecin_document_show', requirements: ['id' => '\d+'], methods: ['GET'])]
    public function show(int $dossierId, Document $document): Response
    {
        ...
        return $this->render('medecin/document/show.html.twig', [
            'document' => $document,
            'dossier' => $dossier,
            'prefix' => '/medecin',
        ]);
    ...
    #[Route('/{id}/modifier', name: 'app_medecin_document_edit', requirements: ['id' => '\d+'], methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_medecin_document_delete', requirements: ['id' => '\d+'], methods: ['POST'])]
