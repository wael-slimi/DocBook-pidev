...
/**
 * Sends emails via Gmail SMTP (mot de passe d'application).
 * Configure MAILER_FROM, MAILER_PASSWORD (app password), and optionally MAILER_TO in .env.
 */
final class EmailService
{
    ...
    /**
     * Send notification when a new dossier is created. Uses default recipient (MAILER_TO).
     */
    ...
    /** SMTP DATA: lines starting with . must be sent as .. */
