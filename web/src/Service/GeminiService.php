...
/**
 * Integration with Google Gemini API for AI-assisted features (summaries, suggestions).
 * Uses Gemini 2.5 Flash. Requires GEMINI_API_KEY in .env / .env.local.
 * See docs/PROPOSITION_GEMINI.md for scenarios and confidentiality (secret médical, RGPD).
 */
final class GeminiService
{
     ...
     * Returns the generated text or null on failure (missing key, API error).
     */
    ...
    /**
     * Generate a detailed medical dossier summary from structured text (dossier + documents).
     * Data is sent to Google's API; see docs for confidentiality (secret médical, RGPD).
     */
